import svgPaths from "./svg-0rdrsyslm1";
...
import imgImage10 from "./ae1fd8add713279ef561906e981941f8c56cc9c8.png";
...
export default function Frame() {
  return (
    <div className="bg-white relative size-full">
      ...
      <div className="absolute h-[484px] left-[447px] pointer-events-none rounded-[22px] top-[2238px] w-[1285px]" data-name="image 10">
        <img alt="" className="absolute inset-0 max-w-none object-cover rounded-[22px] size-full" src={imgImage10} />
