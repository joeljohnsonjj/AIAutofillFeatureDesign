import svgPaths from "./svg-hy6jcykptp";
...
import imgImage7 from "./2f1b73c1dda05fd8860b5a53c38d98eab83f093f.png";
...
export default function Component1stPreview() {
  return (
    <div className="bg-white relative size-full" data-name="1st Preview">
      ...
      <div className="absolute h-[585px] left-[449px] pointer-events-none rounded-[22px] top-[2024px] w-[1282px]" data-name="image 6">
        <img alt="" className="absolute inset-0 max-w-none object-cover rounded-[22px] size-full" src={imgImage7} />
