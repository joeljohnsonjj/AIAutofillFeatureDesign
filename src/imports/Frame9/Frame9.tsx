import svgPaths from "./svg-s1vucbtn62";
...
import imgImage9 from "./9584d6746fb155f034bc645474e98bb06ea80c72.png";
...
function SummaryChanges1() {
  return (
    <div className="absolute content-stretch flex gap-[12px] h-[20px] items-start left-[15px] right-[15px] top-[39px]" data-name="summary-changes-3">
      <ChangeBadge1 />
...
function SummaryItem1() {
  return (
    <div className="absolute bg-[#f0fdf4] border border-[#bbf7d0] border-solid h-[76px] left-[24px] right-[24px] rounded-[6px] top-[165px]" data-name="summary-item-3">
      ...
      <SummaryChanges1 />
      <div className="absolute left-[1603px] size-[40px] top-[3px]" data-name="image 6">
      ...
      <div className="absolute h-[99px] left-[3px] top-[52.5px] w-[1698px]">
        <div className="absolute inset-[0_-0.24%_-8.08%_-0.24%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1706 107">
            <g filter="url(#filter0_d_3_1883)" id="Rectangle 2">
              <path d={svgPaths.p10582900} fill="var(--fill-0, white)" />
            </g>
            <defs>
              <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="107" id="filter0_d_3_1883" width="1706" x="0" y="0">
                ...
                <feBlend in2="BackgroundImageFix" mode="normal" result="effect1_dropShadow_3_1883" />
                <feBlend in="SourceGraphic" in2="effect1_dropShadow_3_1883" mode="normal" result="shape" />
              </filter>
            </defs>
          </svg>
        </div>
...
function SummaryContainer() {
  return (
    <div className="absolute bg-white border border-[#e5e7eb] border-solid h-[463px] left-[112px] rounded-[8px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.1)] top-[1936px] w-[1696px]" data-name="summary-container">
      <SummaryContent />
      <SummaryFooter />
      <div className="absolute left-[1628px] size-[40px] top-[51px]" data-name="image 5">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImage6} />
      </div>
      <div className="absolute left-[1627px] size-[40px] top-[275px]" data-name="image 6">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImage6} />
      </div>
    </div>
  );
...
export default function Frame() {
  return (
    <div className="bg-white relative size-full">
      ...
      <div className="absolute h-[499px] left-[447px] pointer-events-none rounded-[22px] top-[2133px] w-[1285px]" data-name="image 9">
        <img alt="" className="absolute inset-0 max-w-none object-cover rounded-[22px] size-full" src={imgImage9} />
        <div aria-hidden="true" className="absolute border border-black border-solid inset-0 rounded-[22px]" />
      </div>
    </div>
  );
}